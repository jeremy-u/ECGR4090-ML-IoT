...
class RecognizeCommands {
 public:
  ...
  explicit RecognizeCommands(tflite::ErrorReporter* error_reporter,  // <original settings>
                             int32_t average_window_duration_ms = 500, // 1000
                             uint8_t detection_threshold = 200, // 200
                             int32_t suppression_ms = 1500, // 1500 
                             int32_t minimum_count = 2); // 3
